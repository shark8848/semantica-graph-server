...
GRAPH_ENGINE_CELERY_* 环境变量经 ikc_sdk.celery 解析，默认 redis://localhost:6379/0。
celery_enabled（GRAPH_ENGINE_CELERY_ENABLED）
...
# GRAPH_ENGINE_CELERY_SENTINEL_* 生成，入参与 GRAPH_ENGINE_CELERY_BROKER* 都不参与。
celery_app = CeleryFactory.create(
    "graph_engine",
    prefix="GRAPH_ENGINE_CELERY",
